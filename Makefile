...
INC = 
CFLAGS = -Wall -std=c++1z -I/usr/include/SDL2 -I/usr/include/eigen3 -D_REENTRANT
RESINC = 
LIBDIR = 
LIB = -lSDL2 -lGLEW -lGL
LDFLAGS = 
...
DEP_RELEASE = 
OUT_RELEASE = bin/Release/ManyBody

OBJ_DEBUG = $(OBJDIR_DEBUG)/src/Main.o $(OBJDIR_DEBUG)/src/World.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/src/Main.o $(OBJDIR_RELEASE)/src/World.o
